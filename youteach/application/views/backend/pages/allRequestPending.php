                    ...
                    <div class="box">
                        ...
                        foreach($requests as $request) { ?>
                            ...
                            <tr class="">
                                ...
                                <td><span> <a onclick="return conf(1)" href="<?php echo site_url('backend/approveCourse')."/".$request->course_id ?>"  class="btn btn-success btn-circle"><i class="fa fa-check"></i></a>
                                    <a href="<?php echo site_url('backend/allowCourseModification')."/".$request->course_id ?>" onclick="return conf(2)" class="btn btn-warning btn-circle"><i class="fa fa-refresh"></i></a>
                                    <a href="<?php echo site_url('backend/deleteCourseWithMessage')."/".$request->course_id ?>" onclick="return conf(3)" class="btn btn-danger btn-circle"><i class="fa fa-remove"></i></a></span></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
