<div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Received Messages<a href="<?php echo site_url("frontend")."/createMessage" ?>" class="btn btn-primary btn-grad pull-right">New Message <i class="fa fa-envelope-o"> </i></a></h1>
...
<style>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            { ?>
                    <tr class="<?php if($message->viewed == 0) echo "unread"?>">
                <td>
                    <?php echo ++$i; ?>
                </td>
                <td>
                    <a href="<?php echo "/codeigniter/index.php/frontend/createMessage/".urlencode($message->sender_email); ?>"  title="click to reply">
