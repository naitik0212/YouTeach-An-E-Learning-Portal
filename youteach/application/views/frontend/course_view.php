	...
	<script type="text/javascript">
                ...
                $('.inner').readmore({
                    moreLink: '<div class="panel-footer show-more-link text-center"><a href="#" class="">Show more</a></div>',
                    lessLink: '<div class="panel-footer show-less-link text-center"><a href="#" class="">Show less</a><div>',
                    collapsedHeight: 125,
